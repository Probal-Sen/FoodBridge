              ...
              <div className="card h-100 shadow">
                <div className="card-body p-4">
                  <div className="d-flex">
                    ...
                    <div className="ms-4">
                      <p className="mb-1">ZeroWaste Connect has been a game-changer for our restaurant. We feel good knowing our excess food is helping people in need rather than going to waste.</p>
